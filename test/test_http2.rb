...
class TestHTTP2 < Minitest::Test
  ...
  def test_continuation_flood
    ...
    server_session = Kantan::H2::Session.new(server_io, handler: server_handler)
  ...
  def test_data_on_unknown_stream
    ...
    # Send DATA on stream 1 without ever sending HEADERS
    write_frame client_io, 0x00, 1, "hello"
    client_io.flush
